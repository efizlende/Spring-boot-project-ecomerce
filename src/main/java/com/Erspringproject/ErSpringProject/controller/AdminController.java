...
import com.Erspringproject.ErSpringProject.services.categoryService;
...
public class AdminController {
	...
	public ModelAndView adminlogin( @RequestParam("username") String username, @RequestParam("password") String pass) {
		...
		if(user.getRole() != null && user.getRole().equals("ROLE_ADMIN")) {
			...
			mv.addObject("msg", "Por favor digite dados validos");
			return mv;
		}
	}
	...
	public String addProduct(@RequestParam("name") String name, 
	    ...
	    String imagePath = "/img/" + productImage; // Assumindo que productImage é o nome do arquivo
	    
	    // Configurar o caminho completo para a imagem no produto
...
//		this.productService.updateProduct();
	...
	public String profileDisplay(Model model) {
		...
		try
		{
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/syscomerce","root","8463eeEE");
