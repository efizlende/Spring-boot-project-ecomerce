                    ...
                    <form action="userloginvalidate" method="post">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="username" id="username" required placeholder="Nome de usuário" class="form-control form-control-lg">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <span>Não tem uma conta? <a href="/register" class="back">Cadastre-se aqui!</a></span>
